...
<head>
  ...
  <!-- Site Properties -->
  <title>Update Details - Gym Membership Management</title>
...
<!-- Page Contents -->
  ...
  <div class="ui inverted vertical masthead center aligned segment" style="background-image: url('css/images/updatedetails.jpg');">
  ...
  submit.addEventListener('click',(e)=>{
	  e.preventDefault();
		...
		if(userId!="" && firstName!="" && lastName!="" && mobileNo!="" && address!="" && fee!="" && period!="")
		{
		e.preventDefault();
